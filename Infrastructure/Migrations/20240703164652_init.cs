        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceProfileId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Companies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Companies_AspNetUsers_ServiceProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceVal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceProfile", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceProfile_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLoggers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceProfileId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Deals_ServiceProfile_ServiceProfileId",
                        column: x => x.ServiceProfileId,
                        principalTable: "ServiceProfile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_leads_ServiceProfile_ServiceProfileId",
                        column: x => x.ServiceProfileId,
                        principalTable: "ServiceProfile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_ServiceProfileId",
                table: "Companies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deals_ServiceProfileId",
                table: "Deals",
                column: "ServiceProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_leads_ServiceProfileId",
                table: "leads",
                column: "ServiceProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceProfile_UserId",
                table: "ServiceProfile",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLoggers_UserId",
                table: "UserLoggers",
                column: "UserId");
